...
<body>
	<div class="page">
		...
		<div class="block_main_legal">
			...
			<p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site Où Sortir Ce Soir  et leur utilisation par « l'Utilisateur ».<br />
			...
			<strong>Éventuellement :</strong> <br />	
			...
			Où Sortir Ce Soir se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.<br /></p>

			<h3>2 : Définitions</h3>

			<p>La présente clause a pour objet de définir les différents termes essentiels du contrat :<br /><br />

				<strong> Utilisateur </strong>  : ce terme désigne toute personne qui utilise le site ou l'un des services proposés par le site.<br /><br />

				<strong> Contenu utilisateur </strong>  : ce sont les données transmises par l'Utilisateur au sein du site.<br /><br />

				<strong> Membre </strong> : l'Utilisateur devient membre lorsqu'il est identifié sur le site.<br /><br />

				<strong> Identifiant et mot de passe</strong>  : c'est l'ensemble des informations nécessaires à l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent à l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est confidentiel.</p><br />

			<h3>3 : accès aux services</h3><br>


			<p>Le site permet à l'Utilisateur un accès gratuit à tout nos services.<br />
			...
			Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de Où Sortir Ce Soir .<br />
			...
			L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse ousortircesoir@gmail.com .<br /></p>
			...
			Le contenu de l'Utilisateur peut être à tout moment et pour n'importe quelle raison supprimé ou modifié par le site. L'Utilisateur ne reçoit aucune justification et notification préalablement à la suppression ou à la modification du contenu Utilisateur.<br />	</p>
			
			<h3>5 : Données personnelles</h3>

			<p>Les informations demandées à l’inscription au site sont nécessaires et obligatoires pour la création du compte de l'Utilisateur. En particulier, l'adresse électronique pourra être utilisée par le site pour l'administration, la gestion et l'animation du service.<br />

			Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro 07 50 83 60 71.<br />

			En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via :<br /><br />

			 <strong>son espace personnel  </strong>;<br /><br />

			 <strong>un formulaire de contact </strong> ;<br /><br />

			 <strong>par mail à ousortircesoir@gmail.com  </strong> ;<br /><br />

			 <strong>par voie postale au ousortircesoir@gmail.com  </strong>.<br /><br /></p>

			<h3>6 : Responsabilité et force majeure</h3>
			...
			La responsabilité du site ne peut être engagée en cas de force majeure ou du fait imprévisible et insurmontable d'un tiers.<br /></p>

			<h3>7 : Liens hypertextes</h3>

			<p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de Où Sortir Ce Soir qui n'a pas le contrôle de ces liens.<br />
			...
			<p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux de la ville de Angers sont compétents.<br /><br />

			Éventuellement</p>

			<h3>11 : Publication par l’Utilisateur</h3>

			<p>Le site permet aux membres de publier des commentaires .<br /><br />

			Dans ses publications, le membre s’engage à respecter les règles de la Netiquette et les règles de droit en vigueur.<br /><br />

			Le site exerce une modération sur les publications et se réserve le droit de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre.<br /><br />

			Le membre reste titulaire de l’intégralité de ses droits de propriété intellectuelle. Mais en publiant une publication sur le site, il cède à la société éditrice le droit non exclusif et gratuit de représenter, reproduire, adapter, modifier, diffuser et distribuer sa publication, directement ou par un tiers autorisé, dans le monde entier, sur tout support (numérique ou physique), pour la durée de la propriété intellectuelle. Le Membre cède notamment le droit d'utiliser sa publication sur internet et sur les réseaux de téléphonie mobile.<br /><br />
